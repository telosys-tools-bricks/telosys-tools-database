 ...
 *
 */
public class DbMetadataVersion {

	/**
	 * Property name to get the VERSION from properties file
	 */
	private static final VersionProvider versionProvider = new VersionProvider("/telosys-db-metadata-build.properties") ;
	
	/**
	 * Private constructor
	 */
	private DbMetadataVersion() {}
